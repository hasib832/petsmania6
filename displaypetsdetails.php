...
<div class="container col-xs-12 col-sm-12 col-md-6 col-lg-6 column">
  ...
  <div class="img-row">
    ...
    <div class=" top-margin side container col-xs-12 col-sm-12 col-md-6 col-lg-6 column">
        ...
        $query="SELECT * FROM users where id = '".$rows['user_id']."'";
        $result_email = mysqli_query($connection, $query)
            or die($query . " " . mysqli_error($connection));
        while($rows_email=mysqli_fetch_array($result_email))
 {
    $phone=$rows_email['contact'];                
    $email=$rows_email['email'];
 }
        ...
        ?>
          ...
          <div> <span>Phone :</span> <p><?php  echo $phone; ?> </p></div>
       <?php } else {?>
          <div> <span>Email :</span> <p>Login/Signup to view</p></div>
          <div> <span>Phone :</span> <p>Login/Signup to view</p></div>
       <?php } ?>
        </div>
        <?php
