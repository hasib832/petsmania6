...
<header id="header" class="">
            ...
            <ul onclick="toggle()">
                ...
                <li><a href="javascript:void(0)" id='postAdLink' ><span class="glyphicon glyphicon-open"></span> Upload / Add Pets. </a></li>
                <li class="active"><a href="hospitals_pet.php">Hospitals</a></li>
             <li><a href="pettips.php">Tips</a></li>
